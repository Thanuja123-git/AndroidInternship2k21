...
public class MainActivity extends AppCompatActivity implements ItemAdapter.MyInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] itemNames = {"chicken Biryani","Chicken Lolypop","Egg Fried Rice","Chicken65","Mutton curry","Mutton Biryani","Fish Curry","Prawns Curry","veg Noodles","Chicken Noodles"} ;
